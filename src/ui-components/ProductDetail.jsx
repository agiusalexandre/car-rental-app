      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7cov")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerlmy")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7cpu")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerawj")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7rza")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28otp")}
          >
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonswo")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonxoh")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonvnf")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonacn")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28oks")}
          >
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonwav")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonzxy")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonzrr")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonhbj")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
